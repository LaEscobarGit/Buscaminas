...
public class GameBoardPanel extends JPanel {
    ...
    String nombreJugador = "Jugador"; // luego lo puedes cambiar con un cuadro de texto
    ...
    bd.guardarJugador(nombreJugador, puntos);

    System.out.println("🏆 Puntaje guardado en la base de datos local.");
    mostrarTop10();
    return true;
}
    ...
    // 🔹 Guardar el puntaje aunque haya perdido
    bd.guardarJugador(nombreJugador, puntos);
...
private void mostrarTop10() {
    System.out.println("\n🏆 TOP 10 JUGADORES:");
    for (BaseDatosBuscaminas.Jugador j : bd.obtenerTop10()) {
